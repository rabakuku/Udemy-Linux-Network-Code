...
# Compatibility wrapper to keep existing calls working
...
print_netplan_yaml() {
  case "$1" in
    1) print_netplan_yaml_server1 ;;
    2) print_netplan_yaml_server2 ;;
    *) echo "Unknown selector: $1"; return 2 ;;
  esac
  echo "netplan apply"
}
/24
